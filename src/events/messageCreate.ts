...
export default async (bot: ExtendedClient, message: Message) => {
    ...
    const prompt = `Réponds de manière moqueuse, drôle et gênante envers ${originalAuthor}, en te basant sur le message suivant: "${repliedMessage.content}". Rends ça embarrassant pour lui, ajoute des emojis pour amplifier le fun. La réponse doit être courte, maximum 3 lignes.`;
